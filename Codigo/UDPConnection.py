...
class UDPConnection(object):
    ...
    def __init__(self, mac, ip, port, interface):
        ...
        # Abre o socket raw
        self.SocketSnd = socket.socket(socket.AF_INET, socket.SOCK_RAW, socket.IPPROTO_IP)
        self.SocketRcv = socket.socket(socket.AF_INET, socket.SOCK_RAW, socket.IPPROTO_IP)
